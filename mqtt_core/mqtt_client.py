...
class MQTTClient:
    ...
    def _on_connect(self, client, userdata, flags, rc):
        ...
        if rc == 0:
            ...
            # Subscribe to device state updates (adjust pattern to match your Pi topics)
            client.subscribe("state/+")  # Listen to all device state updates
            client.subscribe("response/+")  # Listen to command responses
            logger.info("Subscribed to device state and response topics")
